...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <TooltipPrimitive.Content
    ...
    className={cn(
      "z-50 overflow-hidden rounded-lg border border-border/60 bg-popover px-3 py-1.5 text-sm text-popover-foreground shadow-lg shadow-black/10 backdrop-blur-sm",
